...
def gen(c, v, max, dim):
    ...
    for i in range(dim):
        gata = False
        while gata == False:
            # generates candidate x with elements 0 or 1
        ...
        # adds another list with n+1 elements as an element of list pop
        pop.append(x)
...
def crossover_populatie(pop, c, v, max, pc):
    ...
    grafic.plot(vectv, "rs", markersize=9, label="After recombination")
